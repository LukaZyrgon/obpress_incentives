...
final class OBPress_Incentives_Widget {
	/**
	 * Plugin Version
	 *
	 * @since 1.0.0
    ...
    public function i18n() {
		...
		load_plugin_textdomain( 'obpress-incentive-widget' );
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Test Extension', 'OBPress_Incentives' ) . '</strong>',
	...
	public function init_widgets() {
		...
		require_once(WP_PLUGIN_DIR . '/OBPress_Incentives/widget/incentives.php');
...
OBPress_Incentives_Widget::instance();